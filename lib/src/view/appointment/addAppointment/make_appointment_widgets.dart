...
Form makeAppointmentformWidget(
    AppointmentController appointmentcontroller, BuildContext context) {
  return Form(
    ...
    child: Column(
      children: [
        ...
        joinDate(appointmentcontroller, context),
        ...
        Padding(
          padding:
              const EdgeInsets.only(left: 29, top: 20, right: 90, bottom: 8),
          child: Row(
        ...
        genterAndDobSelector(appointmentcontroller, context),
        ...
        Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (appointmentcontroller.appointmentFormKey.currentState!
                      .validate()) {
                    appointmentcontroller.addappoinmentToFirebase(context);
                  }
                },
        ...
        child: Row(
          children: [
            appointmentcontroller.dob == null
                ...
                : Text(
                    DateFormat('  dd-MM-yy').format(appointmentcontroller.dob!),
                    style: GoogleFonts.poppins(color: Colors.grey),
                  ),
            IconButton(
              onPressed: () async {
                await appointmentcontroller.showDOBCalendarDialog(context);
              },
              icon: const Icon(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              onChanged: (String? newValue) {
                if (newValue != null) {
                  appointmentcontroller.setDropdownValue(newValue);
                }
              },
              items: const [
    ...
    child: Container(
        ...
        child: Row(
          children: [
            ...
            IconButton(
              onPressed: () async {
                await appointmentcontroller.showJOINCalendarDialog(context);
              },
              icon: const Icon(
                Icons.calendar_month,
                color: Colors.white,
